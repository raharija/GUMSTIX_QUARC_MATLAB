...
void COM_Prog_Rover_step1(void)        /* Sample time: [0.01s, 0.0s] */
{
  ...
  real32_T rtb_DataTypeConversion1[3];
  real32_T rtb_RateTransition7[13];
  real32_T tr;
  real32_T tr_0;
  uint8_T rtb_DataTypeConversion[6];
   ...
   *  Sum: '<S9>/Add1'
   */
  rtb_DataTypeConversion1[0] = (real32_T)(uint16_T)((int32_T)((uint32_T)
    (rtb_DataTypeConversion[1] << 7) + (uint32_T)rtb_DataTypeConversion[0]) -
    COM_Prog_Rover_P.Constant_Value_p);
  rtb_DataTypeConversion1[1] = (real32_T)(uint16_T)((int32_T)((uint32_T)
    (rtb_DataTypeConversion[3] << 7) + (uint32_T)rtb_DataTypeConversion[2]) -
    COM_Prog_Rover_P.Constant_Value_c);
  rtb_DataTypeConversion1[2] = (real32_T)(uint16_T)((int32_T)((uint32_T)
  ...
  /* '<S6>:1:2' */
  /* '<S6>:1:3' */
  tr = (rtb_DataTypeConversion1[0] - rtb_DataTypeConversion1[2]) /
    (rtb_DataTypeConversion1[0] + rtb_DataTypeConversion1[2]);

  /* '<S6>:1:4' */
  tr_0 = ((rtb_DataTypeConversion1[0] + rtb_DataTypeConversion1[2]) / 2.0F -
          rtb_DataTypeConversion1[1]) / ((rtb_DataTypeConversion1[0] +
    rtb_DataTypeConversion1[2]) / 2.0F + rtb_DataTypeConversion1[1]);
   ...
   *  Constant: '<S2>/Constant'
   */
  COM_Prog_Rover_DWork.RateTransition20_Buffer0[0] = rtb_DataTypeConversion1[0];
  COM_Prog_Rover_DWork.RateTransition20_Buffer0[1] = rtb_DataTypeConversion1[1];
  COM_Prog_Rover_DWork.RateTransition20_Buffer0[2] = rtb_DataTypeConversion1[2];
  COM_Prog_Rover_DWork.RateTransition20_Buffer0[3] =
    COM_Prog_Rover_P.Constant_Value;
