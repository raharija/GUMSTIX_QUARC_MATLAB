...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_QUARC_Prog_Rover_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_QUARC_Prog_Rover_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_QUARC_Prog_Rover_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_QUARC_Prog_Rover_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_QUARC_Prog_Rover_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "QUARC_Prog_Rover") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_QUARC_Prog_Rover_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_QUARC_Prog_Rover_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "QUARC_Prog_Rover") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_QUARC_Prog_Rover_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_QUARC_Prog_Rover_method_dispatcher(SimStruct *S, unsigned
  ...
  method, void *data)
{
  if (!strcmp(machineName,"QUARC_Prog_Rover")) {
    return(sf_QUARC_Prog_Rover_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void QUARC_Prog_Rover_register_exported_symbols(SimStruct* S);
extern void QUARC_Prog_Rover_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  QUARC_Prog_Rover_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      QUARC_Prog_Rover_debug_initialize();
    }

    QUARC_Prog_Rover_initializer();
  }
